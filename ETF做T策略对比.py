...
dates = [('2017-10-01', '2018-10-01'), ('2018-04-01', '2019-04-01'), ('2018-10-01', '2019-10-01'), ('2019-04-01', '2020-04-01'), ('2019-10-01', '2020-10-01'), ('2020-04-01', '2021-04-01'),]
...
for etf_code in ETFs:
    ...
    for etf_code in ETFs:
        ...
        for date in dates:
            ...
            rate_of_return = method_3(curr_data)
            results[ETFs[etf_code]].append(round(rate_of_return, 2))

    for key, value in results.items():
        print(key, value, round(sum(value)/len(value), 2))


"""
获取数据完毕，开始进行数据分析...
# 持有六个月，恒生 > 银行 > 地产 > 红利，亏损概率分别为：2/13, 4/13, 3/13, 4/13
...
持有一年，银行 > 恒生 > 红利 > 地产，亏损概率分别为：0, 1/6, 2/6, 0
